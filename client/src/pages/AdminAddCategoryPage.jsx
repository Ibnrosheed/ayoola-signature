  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8">
      <div className="flex items-center gap-3 border-b border-slate-200 pb-6">
        ...
        <div>
          <h1 className="font-serif text-3xl font-bold text-slate-900">Add New Category</h1>
          <p className="text-sm text-slate-500">Create a new collection category for the product catalogue</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white border border-slate-200 rounded-3xl p-8 space-y-6 shadow-sm">
        ...
        <div className="space-y-2">
          <label className="text-xs text-slate-700 font-semibold">Category Banner Image</label>
        ...
        <div className="pt-4 flex gap-4">
          ...
          >
            {loading ? <Loader2 className="w-4 h-4 animate-spin text-amber-300" /> : null}
